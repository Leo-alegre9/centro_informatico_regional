...
<div class="bg-white border border-gray-100 rounded-2xl overflow-hidden shadow-[0_1px_4px_rgba(0,0,0,0.05)]">
    <div class="overflow-x-auto">
        <table class="w-full text-[0.88rem] border-collapse" id="tablaMarcas">
            <thead>
                <tr>
                    <th class="bg-gray-50/70 text-gray-500 font-bold text-[0.72rem] uppercase tracking-wider border-b border-gray-100 px-5 py-3.5 whitespace-nowrap text-left">Logo</th>
                    ...
                    <th class="bg-gray-50/70 text-gray-500 font-bold text-[0.72rem] uppercase tracking-wider border-b border-gray-100 px-5 py-3.5 whitespace-nowrap text-left">Sitio web</th>
            ...
            <tbody>
                ...
                <tr class="border-b border-gray-50 hover:bg-gray-50/60 transition-colors" data-busqueda="<?= esc(strtolower($marca['nombre'] . ' ' . $marca['slug'])) ?>">
                    ...
                    <td class="align-middle px-5 py-4"><strong class="text-dark"><?= esc($marca['nombre']) ?></strong></td>
                    <td class="align-middle px-5 py-4"><code class="text-[0.78rem] text-gray-700"><?= esc($marca['slug']) ?></code></td>
                    <td class="align-middle px-5 py-4">
