    ...
    <div class="overflow-x-auto">
        <table class="w-full text-[0.88rem] border-collapse" id="tablaFabricas">
            ...
            <tbody>
                ...
                <tr class="border-b border-gray-100 hover:bg-gray-50" data-busqueda="<?= esc(strtolower($fabrica['nombre'] . ' ' . $fabrica['slug'])) ?>">
                    <td class="align-middle px-4 py-3"><strong class="text-dark"><?= esc($fabrica['nombre']) ?></strong></td>
                    <td class="align-middle px-4 py-3"><code class="text-[0.78rem] text-gray-700"><?= esc($fabrica['slug']) ?></code></td>
